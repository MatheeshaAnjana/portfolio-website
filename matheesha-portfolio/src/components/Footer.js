      ...
      <Container>
        <div className="footer__inner d-flex flex-wrap align-items-center justify-content-between gap-3">
          ...
          <div className="d-flex gap-2">
            <a href="https://linkedin.com/in/matheesha-amarathunga" target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="LinkedIn">
            ...
            <a href="mailto:matheeshaanjana01@gmail.com" className="footer__social" aria-label="Email">
